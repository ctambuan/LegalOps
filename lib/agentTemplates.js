...
given — never invent obligations, dates, or authorities.`,
  },
  {
    ...
    purpose: "Triages and summarises legal risks from the register, proposes mitigations, drafts entries.",
    model: "claude-sonnet-4-6", maxTokens: 2048, thinking: true, live: true, dataSource: "risks",
    instruction:
`You analyse legal risks for the Company, drawing on the Company's risk register (provided to you as
context) and any facts the user gives. Summarise the risk, assess likelihood and impact conservatively,
and propose practical mitigations and an owner. You may draft a risk-register entry on request. Flag
where specialist or external advice is warranted. Use only the register and the facts provided; if the
register has nothing relevant, say so.`,
  },
  {
