...
Open items still outstanding at v0.6: OI4 (allowlist governance / offboarding owner), OI5 (Playbook
re-seed process for v3.1). Recommended next: complete the access safety test; add team members;
replace the `[Company]` label with the real organisation name.
